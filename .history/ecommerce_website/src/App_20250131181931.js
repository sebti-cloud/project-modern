...
import BannerManager from './comp/BannerManager'; // Nouvelle importation
    ...
    <Router>
      ...
      <div id="main-content">
        <Routes>
          ...
          <Route path="/admin/banner-manager" element={isAdminAuthenticated ? <BannerManager /> : <Navigate to="/admin/login" />} /> {/* Nouvelle route */}
