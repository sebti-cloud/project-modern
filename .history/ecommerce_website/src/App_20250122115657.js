    ...
    <Router>
      ...
      <div id="main-content">
        <Routes>
          ...
          <Route path="/*" element={
            <Rout setCart={setCart} cart={cart} shop={shop} Filter={Filter} allcatfilter={allcatfilter} addtocart={addtocart} fetchProducts={fetchProducts} searchproduct={searchproduct} searchResults={searchResults} cartCount={cartCount} setCartCount={setCartCount} /> {/* Passer cartCount et setCartCount */}
          } />
        </Routes>
      </div>
