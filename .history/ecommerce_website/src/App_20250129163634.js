    ...
    <Router>
      ...
      <div id="main-content">
        <Routes>
          ...
          <Route path="/admin/add-admin" element={isAuthenticated ? <AddAdmin /> : <Navigate to="/admin/login" />} />
          <Route path="/admin/products" element={isAuthenticated ? <Products /> : <Navigate to="/admin/login" />} />
          <Route path="/admin/orders" element={isAuthenticated ? <Orders /> : <Navigate to="/admin/login" />} />
          <Route path="/admin/likedProducts" element={isAuthenticated ? <LikedProducts /> : <Navigate to="/admin/login" />} />
          <Route path="/admin/categories" element={isAuthenticated ? <Categories /> : <Navigate to="/admin/login" />} />
          <Route path="/admin/contacts" element={isAuthenticated ? <AdminContacts /> : <Navigate to="/admin/login" />} />
          <Route path="/admin/admins" element={isAuthenticated ? <AdminList /> : <Navigate to="/admin/login" />} />
          <Route path="/admin-settings" element={isAuthenticated ? <AdminSettings /> : <Navigate to="/admin/login" />} />
          <Route path="/admin/admin-users" element={isAuthenticated ? <AdminUsers /> : <Navigate to="/admin/login" />} />
          <Route path="/admin/promotions" element={isAuthenticated ? <Promotions /> : <Navigate to="/admin/login" />} />
          <Route path="/admin/suppliers" element={isAuthenticated ? <Suppliers /> : <Navigate to="/admin/login" />} />
          <Route path="/admin/sales-report" element={isAuthenticated ? <SalesReport /> : <Navigate to="/admin/login" />} />
          <Route path="/admin/stock-history" element={isAuthenticated ? <StockHistory /> : <Navigate to="/admin/login" />} />
