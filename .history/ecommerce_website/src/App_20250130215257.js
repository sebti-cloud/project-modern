...
import StockHistory from './comp/StockHistory';
import Promotions from './comp/Promotions';
import AdminLogin from './comp/AdminLogin';
import Cookies from 'js-cookie'; // Importation de Cookies pour gérer les tokens
    ...
    <Router>
      ...
      <div id="main-content">
        <Routes>
          ...
          <Route path="/admin-settings" element={isAdminAuthenticated ? <AdminSettings /> : <Navigate to="/admin/login" />} />
