...
const AdminHome = () => {
  ...
  return (
    <div className="admin-home">
      <h1>Bienvenue, {admin?.username || 'Admin'} ({admin?.role || 'Rôle inconnu'})</h1>
...
import { Link, useNavigate } from 'react-router-dom';
import { FaBox, FaShoppingCart, FaUser, FaTags, FaChartBar, FaEnvelope, FaUsersCog, FaCogs, FaWarehouse, FaBullhorn } from 'react-icons/fa'; // Ajout de FaBullhorn
import Cookies from 'js-cookie';
import './AdminHome.css';
