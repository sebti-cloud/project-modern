...
import { AiOutlineSearch, AiOutlineUser, AiOutlineShoppingCart, AiOutlineHome, AiOutlineShop, AiOutlineInfoCircle, AiOutlineMail } from "react-icons/ai";
    ...
    <nav className="navbar">
      <div className="navbar-container">
        ...
        <div className="navbar-icons">
          {isAuthenticated ? (
            <>
              <div className="navbar-icon" onClick={logout}><AiOutlineUser title="Déconnexion" /></div>
