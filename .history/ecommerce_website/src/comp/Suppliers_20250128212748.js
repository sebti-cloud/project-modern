...
import { FaBox, FaClipboardList, FaHeart, FaTags, FaEnvelope, FaUserShield, FaUser, FaCog } from 'react-icons/fa'; // Importer des icônes depuis react-icons
import './admin.css';
    ...
    <div className="admin-dashboard">
      ...
      <nav>
        <ul>
          ...
          <li><Link to="/stock-history"><FaWarehouse /> Historique des Stocks</Link></li>
