...
const Home = ({ addtocart, searchResults }) => {
  ...
  const handleMouseEnter = (index) => {
    const slider = document.querySelectorAll('.slick-slider')[index];
    if (slider) {
      slider.slickPlay();
    }
  };
            ...
            <div className='left_box'>
              ...
              <div className='products'>
                {trendingProduct.map((curElm, index) => (
                  <div key={curElm.id} className='box' onMouseEnter={() => handleMouseEnter(index)} onMouseLeave={() => handleMouseLeave(index)}>
                    <div className='img_box'>
                      <Slider {...settings}>
            ...
            <div className='box'>
              ...
              {Array.isArray(newProduct) &&
                newProduct.map((curElm, index) => (
                  <div key={curElm.id} className='productbox' onMouseEnter={() => handleMouseEnter(index)} onMouseLeave={() => handleMouseLeave(index)}>
                                       <div className='img_box'>
                      <Slider {...settings}>
                        {renderProductImages(curElm.images)}
                      </Slider>
