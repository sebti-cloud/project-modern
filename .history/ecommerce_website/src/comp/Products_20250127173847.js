...
const Products = () => {
    ...
    return (
        <div className="admin-dashboard">
            ...
            <table className="products-table">
                <thead>
                    <tr>
                        ...
                        <th>Details</th>
                        <th>Quantity</th>
                        <th>Low Stock Threshold</th> {/* En-tête pour le seuil de stock bas */}
                        <th>Actions</th>
                    </tr>
                </thead>
                <tbody>
                    {products.map(product => (
                        <tr key={product.id} className={product.quantity <= product.lowStockThreshold ? 'low-stock' : ''}>
                            <td>
                            ...
                            <td>{product.lowStockThreshold}</td> {/* Afficher le seuil de stock bas */}
                            <td>
                                <button onClick={() => handleEditProduct(product)} className="edit-button">Edit</button>
                                <button onClick={() => handleDeleteProduct(product.id)} className="delete-button">Delete</button>
                            </td>
            ...
            {products.some(product => product.quantity <= product.lowStockThreshold) && (
