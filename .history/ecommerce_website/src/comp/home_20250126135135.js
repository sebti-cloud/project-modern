...
const Home = ({ addtocart, searchResults }) => {
  ...
  const fetchProducts = async () => {
    try {
      ...
      const newProducts = normalizedData.filter(product => product.types.includes('new'));
      const featuredProducts = normalizedData.filter(product => product.types.includes('featured'));
      const topProducts = normalizedData.filter(product => product.types.includes('top'));
      const trendingProducts = normalizedData;
