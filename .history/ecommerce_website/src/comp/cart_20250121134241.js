...
const Cart = ({ cart, setCart }) => {
  ...
  const [transactionNumber, setTransactionNumber] = useState(''); // Ajouter un état pour le numéro de transaction
  ...
  const copyToClipboard = (text) => {
    console.log('Copying text:', text); // Ajouter un log pour vérifier la valeur copiée
...
<div className="tracking-number-container">
  ...
  <button onClick={() => copyToClipboard(trackingNumber)} className="copy-button">
    <FaCopy /> Copier
  </button>
</div>
