...
import { AiOutlineSearch, AiOutlineUser, AiOutlineShoppingCart, AiOnlineUser, AiOutlineHome, AiOutlineShop, AiOutlineInfoCircle, AiOutlineMail } from "react-icons/ai";
    ...
    <nav className="navbar">
      <div className="navbar-container">
        <Link to="/" className="navbar-logo">
          <img src="http://localhost:3001/uploads/logo.jpg" alt="Logo" />
        </Link>
        ...
        <div className="navbar-icons">
          {isAuthenticated ? (
            <>
              <div className="navbar-icon" onClick={logout}><AiOnlineUser title="Déconnexion" /></div>
            ...
            <>
              <Link to="/login" className="navbar-icon"><AiOutlineUser title="Connexion" /></Link>
            </>
          )}
