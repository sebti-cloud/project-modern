...
const ProductForm = ({ saveProduct, editProduct }) => {
  ...
  const handleSubmit = (e) => {
    ...
    formData.append('quantity', quantity); // Assurez-vous que quantity est transmis
    ...
    if (productId) {
      ...
      editProduct({ id: productId, ...Object.fromEntries(formData) }); // Utilise Object.fromEntries pour convertir formData en objet
    } else {
