...
const App = () => {
  ...
  const addtocart = (product) => {
    ...
    if (exist) {
      ...
      localStorage.setItem('cartCount', cartCount + 1); // Sauvegarder dans localStorage
    }
  };
    ...
    <Router>
      ...
      <div id="main-content">
        <Routes>
          ...
          <Route path="/cart" element={<Cart cart={cart} setCart={setCart} cartCount={cartCount} setCartCount={setCartCount} />} /> {/* Passer cartCount et setCartCount */}
          <Route path="/register" element={<Register />} />
          <Route path="/login" element={<Login setIsAuthenticated={setIsAuthenticated} />} />
          <Route path="/profile" element={isAuthenticated ? <UserProfile cartCount={cartCount} /> : <Navigate to="/login" />} /> {/* Passer cartCount */}
          ...
          <Route path="/*" element={
          <Route setCart={setCart} cart={cart} shop={shop} Filter={Filter} allcatfilter={allcatfilter} addtocart={addtocart} fetchProducts={fetchProducts} searchproduct={searchproduct} searchResults={searchResults} cartCount={cartCount} setCartCount={setCartCount} /> {/* Passer cartCount et setCartCount */}
          } />
        </Routes>
      </div>
