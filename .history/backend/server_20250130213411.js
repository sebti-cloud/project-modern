...
app.post('/api/admin/login', async (req, res) => {
  ...
  try {
    ...
    // Assurez-vous que le rôle est correctement défini dans le payload du token
    const token = jwt.sign({ id: admin.id, name: admin.username, role: 'Admin principal' }, secretKey, { expiresIn: '1h' });
