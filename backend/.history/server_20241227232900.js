...
console.log('Type des informations de connexion PostgreSQL :', {
  user: typeof process.env.PG_USER,
  host: typeof process.env.PG_HOST,
  database: typeof process.env.PG_DATABASE,
  password: typeof process.env.PG_PASSWORD,
